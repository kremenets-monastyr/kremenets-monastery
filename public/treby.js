...
function showConfirm(code){
  ...
  co.innerHTML='<div class="confirm"><div class="cf-ic">✓</div>'
    +'<h3>Записку прийнято</h3>'
    +(code?('<div class="cf-code">Ваш номер запису<br><b>'+code+'</b></div>'):'')
    +'<p class="cf-note">Збережіть цей номер. Реквізити для пожертви надасть обитель; у коментарі до платежу вкажіть <b>номер</b> або ваше <b>ім\u2019я та телефон</b>. Оплатити можна будь-коли протягом 7 днів.</p>'
    +'<button class="cta" onclick="location.reload()">Подати ще одну записку</button></div>';
}
